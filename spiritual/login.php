...
<div class="card-body">
  ...
  <br>
  <form action="authenticate.php" onsubmit = "return validation()" method = "POST">
    <div class="form-group">
      <input type="name" class="form-control" id="text" placeholder="Enter Username" name="user">
    </div>
    <div class="form-group">
      <input type="password" class="form-control" id="text" placeholder="Enter password" name="pass">
    </div>
